...
const TwitterMenuSliderUser = (props) => {
        ...
        <div className="col" id='bbb'>
          {selectedComponent === 'component1' && (
            <div className="component">
              <TweetCardList3 type="t" id={id} islogined={props?.islogined}/>
            </div>
          )}
          {selectedComponent === 'component2' && (
            <div className="component">
              <TweetCardList3 type="l" id={id}  islogined={props?.islogined}/>
            </div>
          )}
          {selectedComponent === 'component3' && (
            <div className="component">
              <TweetCardList3 type="bm" id={id} islogined={props?.islogined}/>
            </div>
          )}
          {selectedComponent === 'component4' && (
            <div className="component">
              <TweetCardList3 type="rp" id={id} islogined={props?.islogined}/>
            </div>
          )}
...
export default TwitterMenuSliderUser;
